...
class CommandsBuilderTest < ActiveSupport::TestCase
  ...
  test "target linux/amd64 locally by default" do
    ...
    assert_equal \
      "docker buildx build --output=type=registry --progress=plain --platform linux/amd64 --builder kamal-local-docker-container -t dhh/app:123 -t dhh/app:latest --cache-to type=gha --cache-from type=gha --label service=\"app\" --file Dockerfile . 2>&1",
      builder.push.join(" ")
  end
  ...
  test "target specified arch locally by default" do
    ...
    assert_equal "local", builder.name
    assert_equal \
      "docker buildx build --output=type=registry --progress=plain --platform linux/amd64 --builder kamal-local-docker-container -t dhh/app:123 -t dhh/app:latest --label service=\"app\" --file Dockerfile . 2>&1",
      builder.push.join(" ")
  end
  ...
  test "hybrid build if remote is set and building multiarch" do
    ...
    assert_equal \
      "docker buildx build --output=type=registry --progress=plain --platform linux/amd64,linux/arm64 --builder kamal-hybrid-docker-container-ssh---app-127-0-0-1 -t dhh/app:123 -t dhh/app:latest --cache-to type=gha --cache-from type=gha --label service=\"app\" --file Dockerfile . 2>&1",
      builder.push.join(" ")
  end
  ...
  test "remote build if remote is set and local disabled" do
    ...
    assert_equal \
      "docker buildx build --output=type=registry --progress=plain --platform linux/amd64,linux/arm64 --builder kamal-remote-ssh---app-127-0-0-1 -t dhh/app:123 -t dhh/app:latest --cache-to type=gha --cache-from type=gha --label service=\"app\" --file Dockerfile . 2>&1",
      builder.push.join(" ")
  end
  ...
  test "target remote when remote set and arch is non local" do
    ...
    assert_equal "remote", builder.name
    assert_equal \
      "docker buildx build --output=type=registry --progress=plain --platform linux/#{remote_arch} --builder kamal-remote-ssh---app-host -t dhh/app:123 -t dhh/app:latest --cache-to type=gha --cache-from type=gha --label service=\"app\" --file Dockerfile . 2>&1",
      builder.push.join(" ")
  end
  ...
  test "target local when remote set and arch is local" do
    ...
    assert_equal "local", builder.name
    assert_equal \
      "docker buildx build --output=type=registry --progress=plain --platform linux/#{local_arch} --builder kamal-local-docker-container -t dhh/app:123 -t dhh/app:latest --cache-to type=gha --cache-from type=gha --label service=\"app\" --file Dockerfile . 2>&1",
      builder.push.join(" ")
  end
  ...
  test "cloud builder" do
    ...
    assert_equal \
      "docker buildx build --output=type=registry --progress=plain --platform linux/#{local_arch} --builder cloud-docker-org-name-builder-name -t dhh/app:123 -t dhh/app:latest --label service=\"app\" --file Dockerfile . 2>&1",
      builder.push.join(" ")
  end
  ...
  test "push with build args" do
    builder = new_builder_command(builder: { "args" => { "a" => 1, "b" => 2 } })
    assert_equal \
      "docker buildx build --output=type=registry --progress=plain --platform linux/amd64 --builder kamal-local-docker-container -t dhh/app:123 -t dhh/app:latest --label service=\"app\" --build-arg a=\"1\" --build-arg b=\"2\" --file Dockerfile . 2>&1",
      builder.push.join(" ")
  end
  ...
  test "push with build secrets" do
    with_test_secrets("secrets" => "a=foo\nb=bar") do
      ...
      assert_equal \
        "docker buildx build --output=type=registry --progress=plain --platform linux/amd64 --builder kamal-local-docker-container -t dhh/app:123 -t dhh/app:latest --label service=\"app\" --secret id=\"a\" --secret id=\"b\" --file Dockerfile . 2>&1",
        builder.push.join(" ")
    end
  end
  ...
  test "context build" do
    ...
    assert_equal \
      "docker buildx build --output=type=registry --progress=plain --platform linux/amd64 --builder kamal-local-docker-container -t dhh/app:123 -t dhh/app:latest --label service=\"app\" --file Dockerfile ./foo 2>&1",
      builder.push.join(" ")
  end
  ...
  test "push with provenance" do
    ...
    assert_equal \
      "docker buildx build --output=type=registry --progress=plain --platform linux/amd64 --builder kamal-local-docker-container -t dhh/app:123 -t dhh/app:latest --label service=\"app\" --file Dockerfile --provenance mode=max . 2>&1",
      builder.push.join(" ")
  end
  ...
  test "push with provenance false" do
    ...
    assert_equal \
      "docker buildx build --output=type=registry --progress=plain --platform linux/amd64 --builder kamal-local-docker-container -t dhh/app:123 -t dhh/app:latest --label service=\"app\" --file Dockerfile --provenance false . 2>&1",
      builder.push.join(" ")
  end
  ...
  test "push with sbom" do
    ...
    assert_equal \
      "docker buildx build --output=type=registry --progress=plain --platform linux/amd64 --builder kamal-local-docker-container -t dhh/app:123 -t dhh/app:latest --label service=\"app\" --file Dockerfile --sbom true . 2>&1",
      builder.push.join(" ")
  end
  ...
  test "push with sbom false" do
    ...
    assert_equal \
      "docker buildx build --output=type=registry --progress=plain --platform linux/amd64 --builder kamal-local-docker-container -t dhh/app:123 -t dhh/app:latest --label service=\"app\" --file Dockerfile --sbom false . 2>&1",
      builder.push.join(" ")
  end
  ...
  test "push with no cache" do
    ...
    assert_equal \
      "docker buildx build --output=type=registry --progress=plain --platform linux/amd64 --builder kamal-local-docker-container -t dhh/app:123 -t dhh/app:latest --label service=\"app\" --file Dockerfile --no-cache . 2>&1",
      builder.push("registry", no_cache: true).join(" ")
  end
